...
class BazierPatchApp : public D3DApp {
public: 
	BazierPatchApp(HINSTANCE hInstance);
	BazierPatchApp(const BazierPatchApp& rhs) = delete;
	BazierPatchApp& operator=(const BazierPatchApp& rhs) = delete;
	~BazierPatchApp();
	...
	PSTR cmdLine, int showCmd)
{
	...
	try {
		BazierPatchApp theApp(hInstance);
...
BazierPatchApp::BazierPatchApp(HINSTANCE hInstance) :D3DApp(hInstance) {

}

BazierPatchApp::~BazierPatchApp()
{
	if (md3dDevice != nullptr)
		FlushCommandQueue();
}

bool BazierPatchApp::Initialize()
{
...
void BazierPatchApp::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void BazierPatchApp::Draw(const GameTimer& gt)
{
...
void BazierPatchApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void BazierPatchApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void BazierPatchApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void BazierPatchApp::OnKeyboardInput(const GameTimer& gt)
{
}

void BazierPatchApp::UpdateCamera(const GameTimer& gt)
{
...
void BazierPatchApp::AnimateMaterials(const GameTimer& gt)
{

}

void BazierPatchApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void BazierPatchApp::UpdateMaterialCBs(const GameTimer& gt)
{
...
void BazierPatchApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void BazierPatchApp::LoadTextures()
{
...
void BazierPatchApp::BuildRootSignature()
{
...
void BazierPatchApp::BuildDescriptorHeaps()
{
	//
	// Create the SRV heap.
	//
...
void BazierPatchApp::BuildShadersAndInputLayout()
{
...
void BazierPatchApp::BuildQuadPatchGeometry()
{
...
void BazierPatchApp::BuildFrameResources()
{
...
void BazierPatchApp::BuildMaterials()
{
...
void BazierPatchApp::BuildRenderItems()
{
...
void BazierPatchApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> BazierPatchApp::GetStaticSamplers()
{
